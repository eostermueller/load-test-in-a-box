...
class JsonParameterSerializationTest {
	...
	@Test
	void canDoRoundTripMethodParameterSerialization() throws Snail4jWorkloadException {
		...
		assertEquals( "com.github.eostermueller.snail4j.workload.annotation.json.parameters.SortingWithParameter", m.getDeclaringClassName() );
